...
#for poster_image
FILENAME_LENGTH = getattr(
    settings, 'BLOGGER_FILENAME_LENGTH', 100)
...
MAXIMUM_THUMBNAIL_FILE_SIZE = getattr(
    settings, 'BLOGGER_MAXIMUM_THUMBNAIL_FILE_SIZE', 200 * 1024 * 1024)

MINIMUM_POSTER_IMAGE_WIDTH = getattr(
    settings, 'BLOGGER_MINIMUM_POSTER_IMAGE_WIDTH', 640)

POSTER_IMAGE_ASPECT_RATIO = getattr(
    settings, 'BLOGGER_POSTER_IMAGE_ASPECT_RATIO', 16.0 / 9.0)

POSTER_IMAGE_ASPECT_RATIO_ERROR = getattr(
    settings, 'BLOGGER_POSTER_IMAGE_ASPECT_RATIO_ERROR', 0.01)
