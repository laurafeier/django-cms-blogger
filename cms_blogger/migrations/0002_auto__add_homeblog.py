...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'HomeBlog'
        db.create_table('cms_blogger_homeblog', (
        ...
        db.send_create_signal('cms_blogger', ['HomeBlog'])


    def backwards(self, orm):
        # Deleting model 'HomeBlog'
        db.delete_table('cms_blogger_homeblog')
