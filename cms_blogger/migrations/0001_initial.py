...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('cms_blogger_blogentrypage', (
            ...
            ('caption', self.gf('django.db.models.fields.CharField')(max_length=70)),
            ('credit', self.gf('django.db.models.fields.CharField')(max_length=35)),
    ...
    models = {
        ...
        'cms_blogger.blogentrypage': {
            ...
            'blog': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['cms_blogger.Blog']"}),
            'caption': ('django.db.models.fields.CharField', [], {'max_length': '70'}),
            'content': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['cms.Placeholder']", 'null': 'True'}),
            'credit': ('django.db.models.fields.CharField', [], {'max_length': '35'}),
